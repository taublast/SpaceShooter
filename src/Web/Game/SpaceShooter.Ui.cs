    ...
    public SpaceShooter()
    {
        ...
        Children = new List<SkiaControl>()
        {
            ...
            new SkiaLayout()
            {
                ...
                Children = new List<SkiaControl>()
                {
                    new SkiaImage()
                    {
                        ...
                        VerticalOptions = LayoutOptions.Fill,
                        Opacity = 0.375,
                        Source = AssetPaths.Resolve("Space/Sprites/nebula.jpg"),
                    },
                    new SkiaImageTiles()
                    {
                        HorizontalOptions = LayoutOptions.Fill,
                        VerticalOptions = LayoutOptions.Fill,
                        Opacity = 0.5,
                        Source = AssetPaths.Resolve("Space/Sprites/stars.png"),
            ...
            new SkiaImage()
            {
                ...
                Source = AssetPaths.Resolve("Space/Sprites/player.png"),
                TranslationY = -40,
                UseCache = SkiaCacheType.Image,
            ...
            new SkiaLottie()
            {
                ...
                LockRatio = 1,
                Opacity = 0.75,
                Source = AssetPaths.Resolve("Space/Lottie/crash.json"),
                SpeedRatio = 0.6,
                Tag = "ShieldExplosion",
                TranslationX = 0,
                TranslationY = -44,
            ...
            new SkiaLottie()
            {
                ...
                Opacity = 0.66,
                Repeat = -1,
                Source = AssetPaths.Resolve("Space/Lottie/shield.json"),
                SpeedRatio = 0.5,
                Tag = "PlayerShield",
                TranslationY = 6,
            ...
            new SkiaImage()
            {
                ...
                HorizontalOptions = LayoutOptions.Fill,
                Opacity = 0.95,
                Source = AssetPaths.Resolve("Space/Sprites/earth.png"),
